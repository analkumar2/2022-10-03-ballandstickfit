...
def get_Vm(numBranches=1, RM_dend=1.86794368, CM_dend=0.02411617, RA_dend=1.18):
    ...
    rdes = rd.rdesigneur(
        ...
        chanDistrib = [
                ...
                ['K_31', 'soma', 'Gbar', f'{0.04407e4*0.4*gbarscaling}'],
                ['K_P', 'soma', 'Gbar', f'{0.23628e4*0.4*gbarscaling}'],
...
tvec1, Ivec1, Vmvec1 =  get_Vm(numBranches=1, RM_dend=1.86794368, CM_dend=0.02411617, RA_dend=1.18)
