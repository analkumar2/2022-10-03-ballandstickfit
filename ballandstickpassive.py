...
def get_scaledpasproperties(ttt=[1,2,3], RA_soma=RA_soma, RM_dend=RM_dend,CM_dend=CM_dend,RA_dend=RA_dend):
...
#         [1,2,3],
#         act_pas,
#         restrict=[[1.17,1,0.01,1.17], [1.19,4,0.04,1.19]],
#         ntol=1000,
#         returnnfactor=0.01,
#         maxfev=1000,
#         printerrors=True,
...
fitted = [1.18, 1.86794368, 0.02411617, 1.18] ##If the RA is exp
print(get_scaledpasproperties([1,2,3], *fitted))
tvec, Ivec, Vmvec = get_Vm(*fitted)
